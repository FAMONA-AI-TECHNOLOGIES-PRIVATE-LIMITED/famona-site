...
import { AlertCircle, TrendingDown, FileWarning, Terminal, ShieldCheck } from 'lucide-react';
...
const HarmIntelligence = () => {
    ...
    const riskTiers = [
        { label: "Safety Mitigation", value: "Verified", icon: TrendingDown, color: "text-blue-500", desc: "Rigorous technical standards for AI governance." },
        { label: "Trust Assurance", value: "Essential", icon: ShieldCheck, color: "text-emerald-500", desc: "Building stakeholder confidence through alignment." },
        { label: "Regulatory Alignment", value: "Standardized", icon: FileWarning, color: "text-indigo-500", desc: "Commitment to global AI regulatory benchmarks." }
    ];
